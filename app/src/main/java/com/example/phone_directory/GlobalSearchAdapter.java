...
public class GlobalSearchAdapter extends RecyclerView.Adapter<GlobalSearchAdapter.RecyclerViewHolder> {
    public ArrayList<model> modelArrayList;
    public Context context;
    public String type;

    public GlobalSearchAdapter(ArrayList<model> modelArrayList, Context context, String type) {
